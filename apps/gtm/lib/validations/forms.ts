...
const readinessScoreSchema = z.object({
  ...
  stage: z.enum(["pre-revenue", "0-5k", "5k-20k", "20k-50k", "50k-plus"]),
  icpClarity: z.enum(["1", "2", "3", "4", "5"]),
  positioningStrength: z.enum(["1", "2", "3", "4", "5"]),
  contentEngine: z.enum(["1", "2", "3", "4", "5"]),
  channelReadiness: z.enum(["0", "1", "2", "3", "4"]),
  salesProcessMaturity: z.enum(["1", "2", "3", "4", "5"]),
  objectionHandling: z.enum(["1", "2", "3", "4", "5"]),
  aiReadiness: z.enum(["1", "2", "3", "4", "5"]),
  pipelineTracking: z.enum(["1", "2", "3", "4", "5"]),
});
...
export const FORM_SCHEMAS: Record<string, z.ZodSchema> = {
  ...
  "readiness-score": readinessScoreSchema,
};
