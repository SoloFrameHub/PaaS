...
export const FORM_DEFINITIONS: Record<string, FormDefinition> = {
  ...
  "beta-tester": {
    ...
    workflows: {
      ...
      adminNotification: {
        to: "aistartuplaunch@gmail.com",
        subject: "New Beta Tester Application from {{name}}",
        includeFields: [
          "name",
          "email",
          "businessModel",
  ...
  "caa-waitlist": {
    ...
    workflows: {
      ...
      adminNotification: {
        to: "aistartuplaunch@gmail.com",
        subject: "New GTM OS Waitlist Signup from {{name}}",
        includeFields: [
          "name",
          "email",
          "businessModel",
        ...
        fields: [
          {
            ...
            required: true,
            options: [
              { id: "lifetime-access", label: "Lifetime academy access" },
