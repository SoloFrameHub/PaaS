    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
      ...
      <div className="sm:flex sm:justify-between sm:items-center mb-5">
        ...
        <div className="mb-4 sm:mb-0">
          <h1 className="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">{isEs ? 'Descubrir Meetups' : 'Discover Meetups'}</h1>
        </div>
        ...
        <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
          ...
          {/* Search form */}
          <SearchForm placeholder={isEs ? 'Buscar…' : 'Search…'} />
          ...
          <button className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">
            ...
            <span className="max-xs:sr-only">{isEs ? 'Agregar meetup' : 'Add Meetup'}</span>
          </button>
      ...
      <div className="mb-5">
        <ul className="flex flex-wrap -m-1">
          ...
          <li className="m-1">
            <button className="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 transition">
              {isEs ? 'Siguiendo' : 'Following'}
            </button>
          </li>
        </ul>
      </div>
      <div className="text-sm text-gray-500 dark:text-gray-400 italic mb-4">{isEs ? '289 Meetups' : '289 Meetups'}</div>
