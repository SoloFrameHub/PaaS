...
export default async function MeetupPost() {
        ...
        <div>
          <div className="mb-6">
            <Link className="btn-sm px-3 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300" href="/community/meetups">
              ...
              <span>{isEs ? 'Volver a Meetups' : 'Back To Meetups'}</span>
            </Link>
          </div>
          <div className="text-sm font-semibold text-primary-500 uppercase mb-2">Mon 27 Dec, 2024 - 9:00 PM -&gt; 10:00 PM</div>
          ...
          <div className="space-y-3 sm:flex sm:items-center sm:justify-between sm:space-y-0 mb-6">
            ...
            <div className="flex flex-wrap items-center sm:justify-end space-x-2">
              ...
              <div className="text-xs inline-flex items-center font-medium border border-gray-200 dark:border-gray-700/60 text-gray-600 dark:text-gray-400 rounded-full text-center px-2.5 py-1">
                ...
                <span>{isEs ? 'Evento en línea' : 'Online Event'}</span>
              </div>
          ...
          {/* Post content */}
          <div>
            <h2 className="text-xl leading-snug text-gray-800 dark:text-gray-100 font-bold mb-2">{isEs ? 'Detalles del Meetup' : 'Meetup Details'}</h2>
          ...
          {/* Photos */}
          <div>
            <h2 className="text-xl leading-snug text-gray-800 dark:text-gray-100 font-bold mb-2">{isEs ? 'Fotos (3)' : 'Photos (3)'}</h2>
          ...
          {/* Comments */}
          <div>
            <h2 className="text-xl leading-snug text-gray-800 dark:text-gray-100 font-bold mb-2">{isEs ? 'Comentarios (3)' : 'Comments (3)'}</h2>
          ...
          {/* Similar Meetups */}
          <div>
            <h2 className="text-xl leading-snug text-gray-800 dark:text-gray-100 font-bold mb-2">{isEs ? 'Meetups similares' : 'Similar Meetups'}</h2>
                ...
                <a className="relative block w-24 sm:w-[14rem] lg:sidebar-expanded:w-20 xl:sidebar-expanded:w-[14rem] shrink-0" href="#0">
                  ...
                  <button className="absolute top-0 right-0 mt-4 mr-4">
                    <div className="text-gray-100 bg-gray-900/60 rounded-full">
                      <span className="sr-only">{isEs ? 'Me gusta' : 'Like'}</span>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white dark:bg-gray-800 p-5 shadow-sm rounded-xl lg:w-[18rem] xl:w-[20rem]">
            <div className="space-y-2">
              <button className="btn w-full bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">
                ...
                <span className="ml-1">{isEs ? 'Asistiré' : 'Attending'}</span>
              </button>
              <button className="btn w-full border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300">
                ...
                <span className="ml-2">{isEs ? 'Favorito' : 'Favorite'}</span>
              </button>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-5 shadow-sm rounded-xl lg:w-[18rem] xl:w-[20rem]">
            <div className="flex justify-between space-x-1 mb-5">
              <div className="text-sm text-gray-800 dark:text-gray-100 font-semibold">{isEs ? 'Asistentes (127)' : 'Attendees (127)'}</div>
              <a className="text-sm font-medium text-primary-500 hover:text-primary-600 dark:hover:text-primary-400" href="#0">
          ...
          <div className="bg-white dark:bg-gray-800 p-5 shadow-sm rounded-xl lg:w-[18rem] xl:w-[20rem]">
            <div className="flex justify-between space-x-1 mb-5">
              <div className="text-sm text-gray-800 dark:text-gray-100 font-semibold">{isEs ? 'Invitar amigos' : 'Invite Friends'}</div>
              <a className="text-sm font-medium text-primary-500 hover:text-primary-600 dark:hover:text-primary-400" href="#0">
                {isEs ? 'Ver todos' : 'View All'}
              </a>
            </div>
