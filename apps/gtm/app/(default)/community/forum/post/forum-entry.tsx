...
export default async function ForumEntry() {
    ...
    <article data-testid="post-detail" className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-5">
      ...
      <div className="mb-2">
        <ul className="inline-flex flex-wrap text-sm font-medium">
          ...
          <li className="flex items-center">
            <a className="text-gray-500 dark:text-gray-400 hover:text-primary-500 dark:hover:text-primary-500" href="#0">
        ...
        <div className="flex items-start space-x-3 mb-3">
          ...
          <div className="grow">
            <label htmlFor="comment" className="sr-only">
              {isEs ? 'Escribe un comentario…' : 'Write a comment…'}
            </label>
            <textarea
              id="comment"
      ...
      {/* Comments */}
      <div className="mt-4">
        <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-4">{isEs ? 'Comentarios' : 'Comments'}</h3>
          ...
          <li className="relative pl-9 space-y-5">
            ...
            <div className="flex items-start">
              ...
              <div className="absolute top-0 left-0">
                <button className="text-xs font-semibold text-left w-6 rounded-xs flex flex-col justify-center items-center text-gray-600 dark:text-gray-300 hover:text-primary-500 dark:hover:text-primary-500">
                  <svg className="inline-flex fill-gray-400 dark:fill-gray-500 mt-1.5 mb-1.5" width="12" height="6" xmlns="http://www.w3.org/2000/svg">
                    <path d="m0 6 6-6 6 6z" />
                  </svg>
                  <div>44</div>
            ...
            <div className="flex items-start">
              ...
              <div className="absolute top-0 left-0">
                <button className="text-xs font-semibold text-left w-6 rounded-xs flex flex-col justify-center items-center text-gray-600 dark:text-gray-300">
                  <svg className="inline-flex fill-primary-500 mt-1.5 mb-1.5" width="12" height="6" xmlns="http://www.w3.org/2000/svg">
                    <path d="m0 6 6-6 6 6z" />
                  </svg>
                  <div>27</div>
                </button>
        ...
        <div className="text-center mt-5">
          <button className="text-sm font-medium text-primary-500 hover:text-primary-600 dark:hover:text-primary-400">{isEs ? 'Ver más comentarios' : 'View More Comments'}</button>
        </div>
      </div>
    </article>
  )
