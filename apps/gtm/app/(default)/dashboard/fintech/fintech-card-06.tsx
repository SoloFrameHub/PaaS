    ...
    <div className="col-span-full xl:col-span-6 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
      ...
      <div className="p-3">
          ...
          <table className="table-auto w-full dark:text-gray-300">
            ...
            <tbody className="text-sm divide-y divide-gray-100 dark:divide-gray-700/60">
              ...
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    <div className="shrink-0 rounded-full mr-2 sm:mr-3 bg-primary-500">
                      <svg className="w-9 h-9 fill-current text-white" viewBox="0 0 36 36">
        ...
        <div className="text-center border-t border-gray-100 dark:border-gray-700/60 px-2">
          <a className="block text-sm font-medium text-primary-500 hover:text-primary-600 dark:hover:text-primary-400 pt-4 pb-1" href="#0">
            View All -&gt;
          </a>
        </div>
      </div>
