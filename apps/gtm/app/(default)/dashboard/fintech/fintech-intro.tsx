      ...
      <div className="px-5 py-6">
        <div className="md:flex md:justify-between md:items-center">
          ...
          <ul className="shrink-0 flex flex-wrap justify-end md:justify-start -space-x-3 -ml-px">
            ...
            <li>
              <button className="flex justify-center items-center w-9 h-9 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-primary-500 shadow-sm transition">
