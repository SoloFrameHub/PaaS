            ...
            <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
              ...
              <div className="max-w-2xl m-auto mt-16">
                ...
                <div className="text-center px-4">
                  ...
                  <div className="mb-6">{isEs ? '¡Ups! Esta página no existe. ¡Intenta buscar otra cosa!' : "Hmm...this page doesn't exist. Try searching for something else!"}</div>
                  <Link href="/" className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">{isEs ? 'Volver al Panel' : 'Back To Dashboard'}</Link>
                </div>
