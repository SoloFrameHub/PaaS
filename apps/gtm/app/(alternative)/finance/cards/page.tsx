      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
        ...
        <div className="space-y-2">
          ...
          <label className="relative block cursor-pointer text-left w-full">
            ...
            <div
              className="absolute inset-0 border-2 border-transparent peer-checked:border-primary-400 dark:peer-checked:border-primary-500 rounded-lg pointer-events-none"
              aria-hidden="true"
            />
          </label>
