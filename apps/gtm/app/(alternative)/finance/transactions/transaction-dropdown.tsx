    ...
    <Menu as="div" className="relative inline-flex">
      <MenuButton className="inline-flex justify-center items-center group">
        <div className="flex items-center truncate">
          <span className="truncate font-medium text-primary-500 group-hover:text-primary-600 dark:group-hover:text-primary-400">My Personal Account</span>
          <svg className="w-3 h-3 shrink-0 ml-1 fill-current text-primary-400" viewBox="0 0 12 12">
