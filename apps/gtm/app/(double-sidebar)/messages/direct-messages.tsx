...
export default function DirectMessages() {
  ...
  return (
    <div className="mt-4">
      ...
      <ul className="mb-6">
        <li className="-mx-2">
          <button className="flex items-center justify-between w-full p-2 rounded-lg bg-linear-to-r from-primary-500/[0.12] dark:from-primary-500/[0.24] to-primary-500/[0.04]" onClick={() => setFlyoutOpen(false)}>
            ...
            <div className="flex items-center ml-2">
              <div className="text-xs inline-flex font-medium bg-primary-400 text-white rounded-full text-center leading-5 px-2">2</div>
            </div>
          </button>
        </li>
        <li className="-mx-2">
          <button className="flex items-center justify-between w-full p-2 rounded-sm" onClick={() => setFlyoutOpen(false)}>
            ...
            <div className="flex items-center ml-2">
              <div className="text-xs inline-flex font-medium bg-primary-400 text-white rounded-full text-center leading-5 px-2">4</div>
            </div>
          </button>
        </li>
        <li className="-mx-2">
