...
test.describe('Dashboard', () => {
    ...
    test('should navigate to academy from dashboard', async ({ page }) => {
        ...
        // Find and click academy link
        const academyLink = page.getByRole('link', { name: /academy|courses|learn/i }).first();

        if (await academyLink.isVisible()) {
...
test.describe('Profile Management', () => {
    ...
    test('should display user profile information', async ({ page }) => {
        ...
        // Should show account settings heading and profile form fields
...
test.describe('Navigation', () => {
    ...
    test('should navigate between main sections', async ({ page }) => {
        ...
        const sections = [
            ...
            { name: /academy/i, url: '/academy' },
            { name: /roleplay/i, url: '/roleplay' },
