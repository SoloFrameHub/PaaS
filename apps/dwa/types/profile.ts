...
export type BusinessModel = 'b2b-saas' | 'creator-coach' | 'service' | 'marketplace' | 'other';
export type Stage = 'idea' | 'pre-launch' | 'pre-revenue' | '0-10k' | '10k-100k' | 'scaling';
export type PrimaryGoal = 'first-10' | 'first-100' | 'conversion' | 'systematic' | 'other';
export type DocumentType = 'pitch-deck' | 'proposal' | 'email-thread' | 'marketing' | 'website-copy' | 'other';
