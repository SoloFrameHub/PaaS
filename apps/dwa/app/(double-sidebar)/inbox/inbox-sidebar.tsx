        ...
        <div>
          ...
          <div className="px-5 py-4">
            ...
            <div className="mt-4">
              ...
              <ul className="mb-6">
                <li className="-mx-2">
                  <button className="flex w-full p-2 rounded-lg bg-linear-to-r from-primary-500/[0.12] dark:from-primary-500/[0.24] to-primary-500/[0.04] text-left" onClick={() => setFlyoutOpen(false)}>
                ...
                <li className="-mx-2">
                  <button className="flex w-full p-2 rounded-sm text-left" onClick={() => setFlyoutOpen(false)}>
                    ...
                    <div className="grow truncate">
                      ...
                      <div className="text-xs font-medium text-gray-800 dark:text-gray-100 truncate mb-0.5">🙌 Share your wellness journey feedback…</div>
                      <div className="text-xs whitespace-normal">Lorem ipsum dolor sit amet, consecte adipiscing elit aute irure dolor…</div>
                    </div>
                  </button>
                </li>
