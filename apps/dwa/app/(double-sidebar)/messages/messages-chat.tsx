  ...
  return (
    <div className="grow px-4 sm:px-6 md:px-5 py-6">
      ...
      <div className="flex items-start mb-4 last:mb-0">
        ...
        <div>
          <div className="text-sm bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-100 p-3 rounded-lg rounded-tl-none mb-1">
            Can anyone help? I have a question about the Stress Management course
          </div>
      ...
      <div className="flex items-start mb-4 last:mb-0">
        ...
        <div>
          <div className="text-sm bg-primary-500 text-white p-3 rounded-lg rounded-tl-none border border-transparent mb-1">
