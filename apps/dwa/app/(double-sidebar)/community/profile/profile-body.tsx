        ...
        <div className="-mt-16 mb-6 sm:mb-3">
          <div className="flex flex-col items-center sm:flex-row sm:justify-between sm:items-end">
            ...
            <div className="flex space-x-2 sm:mb-2">
              ...
              <button className="p-1.5 shrink-0 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm">
                <svg className="fill-current text-primary-500" width="16" height="16" viewBox="0 0 16 16">
        ...
        <header className="text-center sm:text-left mb-6">
          ...
          <div className="flex flex-wrap justify-center sm:justify-start space-x-4">
            ...
            <div className="flex items-center">
              ...
              <a className="text-sm font-medium whitespace-nowrap text-primary-500 hover:text-primary-600 dark:hover:text-primary-400 ml-2" href="#0">
                carolinmcneail.com
              </a>
            </div>
          </div>
        ...
        <div className="relative mb-6">
          ...
          <ul className="relative text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
            <li className="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
              <a className="block pb-3 text-primary-500 whitespace-nowrap border-b-2 border-primary-500" href="#0">
                General
              </a>
            </li>
            <li className="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
        ...
        <div className="flex flex-col xl:flex-row xl:space-x-16">
              ...
              <div className="grid xl:grid-cols-2 gap-4">
                ...
                <div className="bg-white dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-700/60 rounded-lg shadow-sm">
                  ...
                  <div className="grow flex items-center truncate mb-2">
                    ...
                    <div className="truncate">
                      <span className="text-sm font-medium text-gray-800 dark:text-gray-100">Wellness Outreach</span>
                    </div>
                  </div>
                  {/* Card content */}
                ...
                <div className="bg-white dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-700/60 rounded-lg shadow-sm">
                  ...
                  <div className="grow flex items-center truncate mb-2">
                    ...
                    <div className="truncate">
                      <span className="text-sm font-medium text-gray-800 dark:text-gray-100">Course Development</span>
                    </div>
                  </div>
                  {/* Card content */}
                  <div className="text-sm mb-3">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore.</div>
              ...
              <div className="bg-white dark:bg-gray-900 p-4 border border-gray-200 dark:border-gray-700/60 rounded-lg shadow-sm">
                <ul className="space-y-3">
                  ...
                  <li className="sm:flex sm:items-center sm:justify-between">
                    <div className="sm:grow flex items-center text-sm">
                      {/* Icon */}
                      <div className="w-8 h-8 rounded-full shrink-0 bg-primary-500 my-2 mr-3">
                        <svg className="w-8 h-8 fill-current text-primary-50" viewBox="0 0 32 32">
          ...
          <aside className="xl:min-w-[14rem] xl:w-[14rem] space-y-3">
            ...
            <div className="text-sm">
              ...
              <div>carolyn@wellnessacademy.com</div>
            </div>
            <div className="text-sm">
            ...
            <div className="text-sm">
              <h3 className="font-medium text-gray-800 dark:text-gray-100">Member Since</h3>
