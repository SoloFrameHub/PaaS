        ...
        <div>
                ...
                <div className="relative">
                  <div className="grow flex items-center truncate">
                    ...
                    <div className="truncate">
                      <span className="font-semibold text-gray-800 dark:text-gray-100">Wellness Community</span>
                    </div>
                  </div>
                </div>
                {/* Add button */}
          ...
          <div className="px-5 py-4">
            ...
            <div className="mt-4">
              ...
              <ul className="mb-6">
                <li className="-mx-2">
                  <button className="w-full p-2 rounded-lg bg-linear-to-r from-primary-500/[0.12] dark:from-primary-500/[0.24] to-primary-500/[0.04]" onClick={() => setFlyoutOpen(false)}>
