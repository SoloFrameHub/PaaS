export const metadata = {
  title: 'Community Members - Wellness Academy',
  ...
  const users = [
    {
      ...
      link: '#0',
      location: '🇮🇹',
      content: 'Wellness advocate, mindfulness practitioner, community supporter &amp; lifelong learner.',
    },
    {
      id: 1,
      name: 'Ivan Mesaros',
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
      ...
      <div className="sm:flex sm:justify-between sm:items-center mb-8">
        ...
        <div className="mb-4 sm:mb-0">
          <h1 className="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Wellness Community</h1>
        </div>
