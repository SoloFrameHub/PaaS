    ...
    <div className="grid xl:grid-cols-2 gap-6">
      ...
      <article className="flex bg-white dark:bg-gray-800 shadow-sm rounded-xl overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-primary-500 uppercase mb-2">Mon 27 Dec, 2024</div>
            <Link className="inline-flex mb-2" href="/community/meetups/post">
              <h3 className="text-lg font-bold text-gray-800 dark:text-gray-100">Morning Mindfulness Circle — Weekly Online Gathering</h3>
            </Link>
            <div className="text-sm">
              Join fellow learners for guided discussions, shared experiences, and evidence-based wellness practices in a safe, supportive space.
            </div>
          </div>
          {/* Footer */}
      ...
      <article className="flex bg-white dark:bg-gray-800 shadow-sm rounded-xl overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-primary-500 uppercase mb-2">Mon 27 Dec, 2024</div>
            <Link className="inline-flex mb-2" href="/community/meetups/post">
              <h3 className="text-lg font-bold text-gray-800 dark:text-gray-100">East Coast Virtual Wellness Retreat 2026</h3>
            </Link>
            <div className="text-sm">
              Join fellow learners for guided discussions, shared experiences, and evidence-based wellness practices in a safe, supportive space.
            </div>
      ...
      <article className="flex bg-white dark:bg-gray-800 shadow-sm rounded-xl overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-primary-500 uppercase mb-2">Wed 29 Dec, 2024</div>
            <Link className="inline-flex mb-2" href="/community/meetups/post">
              <h3 className="text-lg font-bold text-gray-800 dark:text-gray-100">Understanding Anxiety — Open Support Chat</h3>
            </Link>
            <div className="text-sm">
              Join fellow learners for guided discussions, shared experiences, and evidence-based wellness practices in a safe, supportive space.
            </div>
      ...
      <article className="flex bg-white dark:bg-gray-800 shadow-sm rounded-xl overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-primary-500 uppercase mb-2">Wed 29 Dec, 2024</div>
            <Link className="inline-flex mb-2" href="/community/meetups/post">
              <h3 className="text-lg font-bold text-gray-800 dark:text-gray-100">Breathwork &amp; Journaling Workshop @ Brooklyn Wellness Hub</h3>
            </Link>
            <div className="text-sm">
              Join fellow learners for guided discussions, shared experiences, and evidence-based wellness practices in a safe, supportive space.
            </div>
      ...
      <article className="flex bg-white dark:bg-gray-800 shadow-sm rounded-xl overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-primary-500 uppercase mb-2">Mon 3 Jan, 2024</div>
            <Link className="inline-flex mb-2" href="/community/meetups/post">
              <h3 className="text-lg font-bold text-gray-800 dark:text-gray-100">Wellness Academy Meetup: Women in Mental Health</h3>
            </Link>
            <div className="text-sm">
              Join fellow learners for guided discussions, shared experiences, and evidence-based wellness practices in a safe, supportive space.
            </div>
      ...
      <article className="flex bg-white dark:bg-gray-800 shadow-sm rounded-xl overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-primary-500 uppercase mb-2">Thu 6 Jan, 2024</div>
            <Link className="inline-flex mb-2" href="/community/meetups/post">
              <h3 className="text-lg font-bold text-gray-800 dark:text-gray-100">Wellness Community — New Year Intentions Circle 2026</h3>
            </Link>
            <div className="text-sm">
              Join fellow learners for guided discussions, shared experiences, and evidence-based wellness practices in a safe, supportive space.
            </div>
      ...
      <article className="flex bg-white dark:bg-gray-800 shadow-sm rounded-xl overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-primary-500 uppercase mb-2">Thu 6 Jan, 2024</div>
            <Link className="inline-flex mb-2" href="/community/meetups/post">
              <h3 className="text-lg font-bold text-gray-800 dark:text-gray-100">Sleep Wellness Network — Monthly Support Group</h3>
            </Link>
            <div className="text-sm">
              Join fellow learners for guided discussions, shared experiences, and evidence-based wellness practices in a safe, supportive space.
            </div>
      ...
      <article className="flex bg-white dark:bg-gray-800 shadow-sm rounded-xl overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-primary-500 uppercase mb-2">Fri 7 Jan, 2024</div>
            <Link className="inline-flex mb-2" href="/community/meetups/post">
              <h3 className="text-lg font-bold text-gray-800 dark:text-gray-100">Build Emotional Resilience — Guided Group Workshop</h3>
            </Link>
            <div className="text-sm">
              Join fellow learners for guided discussions, shared experiences, and evidence-based wellness practices in a safe, supportive space.
            </div>
