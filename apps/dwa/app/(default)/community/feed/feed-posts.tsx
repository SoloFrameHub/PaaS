...
export default function FeedPosts() {
  return (
    <>
      {/* Post 1 */}
      <div data-testid="feed-post" className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-5">
        {/* Header */}
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <div className="leading-tight">
                <Link className="text-sm font-semibold text-gray-800 dark:text-gray-100" data-testid="post-author-link" href="/community/profile">
                  Dominik Lamakani
                </Link>
              </div>
        ...
        <footer className="flex items-center space-x-4">
          {/* Like button */}
          <button data-testid="like-button" className="flex items-center text-gray-400 dark:text-gray-500 hover:text-primary-500 dark:hover:text-primary-500">
          ...
          {/* Share button */}
          <button className="flex items-center text-gray-400 dark:text-gray-500 hover:text-primary-500 dark:hover:text-primary-500">
            <svg className="shrink-0 fill-current mr-1.5" width="16" height="16" viewBox="0 0 16 16">
          ...
          {/* Replies button */}
          <button data-testid="comment-button" className="flex items-center text-gray-400 dark:text-gray-500 hover:text-primary-500 dark:hover:text-primary-500">
            <svg className="shrink-0 fill-current mr-1.5" width="16" height="16" viewBox="0 0 16 16">
          ...
          <div className="relative my-4!">
            ...
            <div className="absolute left-0 right-0 bottom-0 p-4 bg-black/25 backdrop-blur-md">
              <div className="flex items-center justify-between">
                ...
                <a className="text-xs font-medium text-primary-400 hover:text-primary-300" href="#0">
                  Learn More -&gt;
                </a>
              </div>
            </div>
      ...
      <div data-testid="feed-post" className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-5">
        ...
        <div className="mt-5 pt-3 border-t border-gray-100 dark:border-gray-700/60">
          ...
          <div className="flex justify-between space-x-2">
            ...
            <button className="text-sm font-medium text-primary-500 hover:text-primary-600 dark:hover:text-primary-400">View More Comments</button>
          </div>
          {/* Comment form */}
      ...
      <div data-testid="feed-post" className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-5">
        ...
        <footer className="flex items-center space-x-4">
          {/* Like button */}
          <button data-testid="like-button" className="flex items-center text-primary-400 dark:text-primary-500">
            <svg className="shrink-0 fill-current mr-1.5" width="16" height="16" viewBox="0 0 16 16">
              <path d="M14.682 2.318A4.485 4.485 0 0011.5 1 4.377 4.377 0 008 2.707 4.383 4.383 0 004.5 1a4.5 4.5 0 00-3.182 7.682L8 15l6.682-6.318a4.5 4.5 0 000-6.364zm-1.4 4.933L8 12.247l-5.285-5A2.5 2.5 0 014.5 3c1.437 0 2.312.681 3.5 2.625C9.187 3.681 10.062 3 11.5 3a2.5 2.5 0 011.785 4.251h-.003z" />
            </svg>
            <div className="text-sm text-primary-500">2.2K</div>
          </button>
          {/* Share button */}
          <button className="flex items-center text-gray-400 dark:text-gray-500 hover:text-primary-500 dark:hover:text-primary-500">
            <svg className="shrink-0 fill-current mr-1.5" width="16" height="16" viewBox="0 0 16 16">
