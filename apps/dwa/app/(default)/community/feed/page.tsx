                  ...
                  <div className="flex justify-between items-center">
                    <div className="grow flex space-x-5">
                      <button className="inline-flex items-center text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-200">
                        <svg className="fill-primary-400 mr-2" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                      <button type="submit" data-testid="create-post-button" className="btn-sm bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white whitespace-nowrap">
                        Send -&gt;
                      </button>
                    </div>
                  </div>
