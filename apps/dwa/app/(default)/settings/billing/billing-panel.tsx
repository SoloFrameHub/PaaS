          ...
          <ul>
            <li className="md:flex md:justify-between md:items-center py-3 border-b border-gray-200 dark:border-gray-700/60">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400 ml-4">
                ...
                <a className="font-medium text-primary-500 hover:text-primary-600 dark:hover:text-primary-400" href="#0">Edit</a>
              </div>
            </li>
            <li className="md:flex md:justify-between md:items-center py-3 border-b border-gray-200 dark:border-gray-700/60">
              {/* Left */}
            ...
            <li className="md:flex md:justify-between md:items-center py-3 border-b border-gray-200 dark:border-gray-700/60">
              ...
              {/* Right */}
              <div className="text-sm text-gray-600 dark:text-gray-400 ml-4">
                <span className="mr-3">billing@wellnessacademy.com</span>
                <a className="font-medium text-primary-500 hover:text-primary-600 dark:hover:text-primary-400" href="#0">Edit</a>
              </div>
            </li>
          </ul>
