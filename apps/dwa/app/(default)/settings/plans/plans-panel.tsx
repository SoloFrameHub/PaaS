  ...
  return (
    <div className="grow">
      ...
      <div className="p-6 space-y-6">
        ...
        <section>
          ...
          <div>
            ...
            <div className="grid grid-cols-12 gap-6">
              ...
              {/* Tab 3 */}
              <div className="relative col-span-full xl:col-span-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 shadow-sm rounded-b-lg">
                <div className="absolute top-0 left-0 right-0 h-0.5 bg-primary-500" aria-hidden="true"></div>
                <div className="px-5 pt-5 pb-6 border-b border-gray-200 dark:border-gray-700/60">
                  <header className="flex items-center mb-2">
        ...
        {/* Contact Sales */}
        <section>
          <div className="px-5 py-3 bg-linear-to-r from-primary-500/[0.12] dark:from-primary-500/[0.24] to-primary-500/[0.04] rounded-lg text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center">
        ...
        <section>
          ...
          <ul className="space-y-5">
            ...
            <li>
              ...
              <div className="text-sm">
                Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum in voluptate velit esse cillum dolore eu fugiat <a className="font-medium text-primary-500 hover:text-primary-600 dark:hover:text-primary-400" href="#0">contact us</a>.
              </div>
            </li>
          </ul>
        </section>
