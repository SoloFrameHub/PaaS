...
export default function AnalyticsCard10() {
  ...
  const chartData = {
    labels: ['Self-Paced', 'Guided', 'Group Sessions'],
    datasets: [
      {
        ...
        backgroundColor: [
          adjustColorOpacity(getCssVariable('--color-primary-500'), 0.8),
          adjustColorOpacity(getCssVariable('--color-sky-500'), 0.8),
          adjustColorOpacity(getCssVariable('--color-green-500'), 0.8),
        ],
        hoverBackgroundColor: [
          adjustColorOpacity(getCssVariable('--color-primary-600'), 0.8),
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
      <header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
        <h2 className="font-semibold text-gray-800 dark:text-gray-100">Learning Style Preference</h2>
      </header>
