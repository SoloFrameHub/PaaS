...
const RealtimeChart = dynamic(() => import('@/components/charts/realtime-chart'), {
  loading: () => <div className="h-[248px] w-full bg-gray-100 dark:bg-gray-800 animate-pulse rounded-xl" />,
  ssr: false
})
...
export default function DashboardCard05() {
  ...
  // Fake update every 2 seconds with proper cleanup
  useEffect(() => {
    let isMounted = true;
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
      <header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60 flex items-center">
        <h2 className="font-semibold text-gray-800 dark:text-gray-100">Live Wellness Activity</h2>
        <Tooltip className="ml-2">
          <div className="text-xs text-center whitespace-nowrap">Real-time learner activity on the platform</div>
        </Tooltip>
      </header>
