export const metadata = {
  title: 'Breadcrumb - Wellness Academy',
                ...
                <div className="text-center">
                  ...
                  <ul className="inline-flex flex-wrap text-sm font-medium">
                    <li className="after:content-['/'] last:after:hidden after:text-gray-400 dark:after:text-gray-600 after:px-2">
                      <a className="text-gray-500 dark:text-gray-400 hover:text-primary-500 dark:hover:text-primary-500" href="#0">Home</a>
                    </li>
                    <li className="after:content-['/'] last:after:hidden after:text-gray-400 dark:after:text-gray-600 after:px-2">
                      <a className="text-gray-500 dark:text-gray-400 hover:text-primary-500 dark:hover:text-primary-500" href="#0">Settings</a>
                    </li>
                    <li className="after:content-['/'] last:after:hidden after:text-gray-400 dark:after:text-gray-600 after:px-2">
                      <a className="text-gray-500 dark:text-gray-400 hover:text-primary-500 dark:hover:text-primary-500" href="#0">Notifications</a>
                    </li>
                  </ul>
                  {/* End */}
                </div>
