            ...
            <div className="mb-2 text-center">
              ...
              <div className="mb-3">
                <svg className="inline-flex w-12 h-12 rounded-full shrink-0 fill-current" viewBox="0 0 48 48">
                  ...
                  <path className="text-primary-300" d="M19 16h7a8 8 0 110 16h-7V16z" />
                  <path className="text-primary-500" d="M26 24l-7-6v5h-8v2h8v5z" />
                </svg>
              </div>
          ...
          <ModalAction isOpen={integrationModalOpen} setIsOpen={setIntegrationModalOpen}>
            ...
            <div className="mb-5 text-center">
              ...
              <div className="inline-flex items-center justify-center space-x-3 mb-4">
                {/* Wellness Academy logo */}
                <div className="flex justify-center items-center w-12 h-12 rounded-full bg-gray-100 dark:bg-gray-700">
                  <svg className="fill-primary-500 w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                ...
                <svg width="48" height="48" viewBox="0 0 48 48">
                  <rect className="fill-gray-100 dark:fill-primary-500/30" width="48" height="48" rx="24" />
              ...
              <div className="text-lg font-semibold text-gray-800 dark:text-gray-100">Connect Wellness Academy with your account</div>
            </div>
            {/* Modal content */}
            <div className="text-sm mb-5">
              <div className="font-medium text-gray-800 dark:text-gray-100 mb-3">Wellness Academy would like to:</div>
              ...
              <div className="text-xs text-gray-500">By clicking on Allow access, you authorize Wellness Academy to use your information in accordance with its <a className="text-primary-500 hover:text-primary-600 dark:hover:text-primary-400" href="#0">Privacy Policy</a>. You can stop it at any time on the integrations page of your Wellness Academy account.</div>
            </div>
            {/* Modal footer */}
            <div className="flex flex-wrap justify-end space-x-2">
        ...
        <div className="m-1.5">
          ...
          <ModalBlank isOpen={newsModalOpen} setIsOpen={setNewsModalOpen}>
            <div className="relative">
              <Image className="w-full" src={ModalImage} width={460} height="200" alt="New Feature" />
              {/* Close button */}
            ...
            <div className="p-5">
              ...
              <div className="mb-2">
                <div className="mb-3">
                  <div className="btn-xs text-xs border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300 px-2.5 py-1 rounded-full shadow-none">New Feature</div>
                </div>
            ...
            <div className="px-5 pt-4 pb-1">
              <div className="text-sm">
                ...
                <ul className="space-y-2 mb-4">
                  <li>
                    <button className="w-full h-full text-left py-3 px-4 rounded-lg bg-white dark:bg-gray-800 border-2 border-primary-400 dark:border-primary-500 shadow-sm transition">
                      <div className="flex items-center">
                        <div className="w-4 h-4 border-4 bg-white border-primary-500 rounded-full mr-3"></div>
                        <div className="grow">
                          <div className="flex flex-wrap items-center justify-between mb-0.5">
                            <span className="font-medium text-gray-800 dark:text-gray-100">Wellness Starter <span className="text-xs italic text-gray-500 align-top">Current Plan</span></span>
                  ...
                  <li>
                    <button className="w-full h-full text-left py-3 px-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm transition">
                      <div className="flex items-center">
                        ...
                        <div className="grow">
                          <div className="flex flex-wrap items-center justify-between mb-0.5">
                            <span className="font-semibold text-gray-800 dark:text-gray-100">Wellness Essential <span className="text-xs italic text-primary-500 align-top">Best Value</span></span>
                  ...
                  <li>
                    <button className="w-full h-full text-left py-3 px-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm transition">
                      <div className="flex items-center">
                        ...
                        <div className="grow">
                          <div className="flex flex-wrap items-center justify-between mb-0.5">
                            <span className="font-semibold text-gray-800 dark:text-gray-100">Wellness Premium</span>
                ...
                <div className="text-xs text-gray-500">Your workspace&apos;s Wellness Starter Plan is set to $39 per month and will renew on August 9, 2024.</div>
              </div>
            </div>
            {/* Modal footer */}
            <div className="px-5 py-4">
