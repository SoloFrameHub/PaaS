          ...
          <div className="space-y-8 mt-8">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center -m-1.5">
                ...
                <div className="m-1.5">
                  {/* Start */}
                  <button className="btn bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-primary-500">Tertiary</button>
                  {/* End */}
                </div>
                <div className="m-1.5">
                  {/* Start */}
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center -m-1.5">
                ...
                <div className="m-1.5">
                  {/* Start */}
                  <button className="btn bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600">
                    <svg className="fill-current text-primary-500 shrink-0" width="16" height="16" viewBox="0 0 16 16">
              ...
              <div className="flex flex-wrap items-center -m-1.5">
                <div className="m-1.5">
                  ...
                  <div className="flex flex-wrap -space-x-px">
                    <button className="btn bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 text-primary-500 rounded-none first:rounded-l-lg last:rounded-r-lg">Weekly</button>
