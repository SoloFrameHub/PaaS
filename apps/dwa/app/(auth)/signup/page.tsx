            ...
            <div className="max-w-sm mx-auto w-full px-4 py-8">
                ...
                <div className="flex items-center justify-between mt-6">
                  <div className="mr-1">
                    <label className="flex items-center">
                      ...
                      <span className="text-sm ml-2">I accept the Terms and Conditions</span>
                    </label>
                  </div>
                  <button
                    type="submit"
              ...
              <div className="pt-5 mt-6 border-t border-gray-100 dark:border-gray-700/60">
                <div className="text-sm">
                  Have an account? <Link className="font-medium text-primary-500 hover:text-primary-600 dark:hover:text-primary-400" href="/signin">Sign In</Link>
                </div>
              </div>
            </div>
          </div>
