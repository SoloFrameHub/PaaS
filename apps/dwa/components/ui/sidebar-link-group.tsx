...
export default function SidebarLinkGroup({
  ...
  return (
    <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r group is-link-group ${open && 'from-primary-500/[0.12] dark:from-primary-500/[0.24] to-primary-500/[0.04]'}`}>
